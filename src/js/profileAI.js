...
document.addEventListener("click", (event) => {
    if (event.target.classList.contains("clicavel")) {
        ...
        if (userName === currentUserName) {
            ...
            loadPage("profile", "profileAI.html", () => {
                    ...
                    usuario.posts.forEach(post => {
                        const postHTML = `
                            <div class="post-card">
                                ...
                                <p class="post-hashtags">${transformarHashtagsEmLinks(post.hashtags)}</p>
                            </div>
                        `;
                        postListContainer.insertAdjacentHTML("beforeend", postHTML);
                    });

                    // Adiciona eventos de clique nas hashtags.
